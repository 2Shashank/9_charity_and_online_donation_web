<?php
  ...
  if (isset($_GET["email"])) {
      ...
      // Now you have the email, and you can use it as needed in your page
  } else {
      // Handle the case where the email parameter is not provided
    ...
    <section class="donor-profile">
      <div class="profile-info">
        ...
        <div class="button-group">
          <button class="donate-button" onclick="redirectToDonationForm()">Make a Donation</button><br /><br />
          <button class="history-button" onclick="$">Donation History</button><br /><br />
